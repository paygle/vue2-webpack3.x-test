...
<script type="text/babel">
  ...
  import ElSelectMenu from 'element-ui/packages/select/src/select-dropdown.vue'; // ext-> modify
  import ElxOption from './option.vue';
  ...
  import NavigationMixin from 'element-ui/packages/select/src/navigation-mixin'; // ext-> modify
